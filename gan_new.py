...
class GAN():
    ...
    def train(self, epochs, batch_size=128, sample_interval=50):
        ...
        for epoch in range(epochs):
            ...
            # Fit the discriminator with actual images
            self.discriminator.fit(imgs, valid, batch_size, 1)

            # Fit the discriminator with generated images
            self.discriminator.fit(gen_imgs, fake, batch_size, 1)
